  ...
  const items: ShowImageListItemProps[] = [
    {
      ...
      images: [
        {
          src: "https://images.unsplash.com/photo-1567688894918-ee4b1ac19e72?w=200&auto=format&fit=crop&q=60",
          alt: "Bold retail signage",
        },
        {
          src: "https://images.unsplash.com/photo-1586880244406-556ebe35f282?w=200&auto=format&fit=crop&q=60",
          alt: "Neon sign display",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=200&auto=format&fit=crop&q=60",
          alt: "Wrapped car in street",
        },
        {
          src: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=200&auto=format&fit=crop&q=60",
          alt: "Colourful vehicle livery",
        },
      ],
    },
    {
